 ...
 * @version V2.0
 */
public class GraceJSONResult<T> {
     ...
     * @return
     */
    public static <T> GraceJSONResult ok(T data) {
    ...
    public GraceJSONResult(ResponseStatusEnum responseStatus, T data) {
        this.status = responseStatus.status();
        this.msg = responseStatus.msg();
        this.success = responseStatus.success();
        this.data = data;
