...
public interface BaseInfoProperties {
...
//
//        PagedGridResult gridResult = new PagedGridResult();
//        gridResult.setRows(list);                     // list是当前页需要展示的记录
//        gridResult.setPage(pageInfo.getCurrent());   // current表示当前页
//        gridResult.setRecords(pageInfo.getTotal());  // records表示总记录数
//        gridResult.setTotal(pageInfo.getPages());  // total表示总页数
//        return gridResult;
//    }
//
